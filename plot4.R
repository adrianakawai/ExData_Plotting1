## The funtion plot4 creates 4 plots diplayed in 2 rows and 2 columns
...
plot4 <- function() {
    ...
    ## Set the screen to have 2 rows and 2 columns in order to display 4 plots
    par(mfrow=c(2,2))
    
    ## Plot the global active power column using "plot" function
    plot(data$Time, data$Global_active_power, xlab = "", ylab = "Global Active Power", type = "l")
    
    ## Plot the voltage column using "plot" function
    plot(data$Time, data$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
    
    ## Plot energy sub metering columns using "plot" function for the first measure (energy sub
    ...
    ## Plot the global reactive power column using "plot" function
